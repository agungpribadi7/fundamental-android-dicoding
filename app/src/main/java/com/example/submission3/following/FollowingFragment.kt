...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val url = "https://api.github.com/users/${user?.username}/following"
    ...
    fun showRecycleView(){
        binding.rvMainFollowing.layoutManager = LinearLayoutManager(activity)
        adapter = FollowingAdapter(listUser)
        binding.rvMainFollowing.adapter = adapter
    }
}